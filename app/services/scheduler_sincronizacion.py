...
"""
Scheduler para ejecutar sincronización automática diariamente a las 8 AM (Quito)
Usa APScheduler
"""
...
def _tarea_sincronizacion_diaria():
    ...
    Sincroniza el día anterior cada día a las 8 AM Quito
    """
    try:
...
def inicializar_scheduler():
    ...
    Ejecuta sincronización a las 8:00 AM zona horaria Quito (UTC-5)
    """
    ...
    try:
        ...
        # Configurar trigger CRON para 8:00 AM
        # hour=8, minute=0 = 8:00 AM todos los días
        ...
        log("✅ [SCHEDULER] Inicializado - Sincronización cada día a las 8:00 AM (Quito)")
        return True
